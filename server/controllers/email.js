...
const sendInvitation = async (postData) => {
  ...
  let url = `https://wedgrab.com/meetingroom/${meetingId}`;
  ...
  let body = {
    ...
    html: `<h2>${userName} has sent you a invitation to join Meeting</h2></br><h5>Meeting Details</h5></br><p>Topic : ${topic}</p></br><ul><li>Meeting Link: <a href=https://wedgrab.com/meetingroom/${meetingId} >https://wedgrab.com/meetingroom/${meetingId}</a></li><li>Meeting ID: ${meetingId}</li><li>Scheduled at: ${date}</li><li>Time: ${time}</li></ul>`,
  };
